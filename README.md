...
>
> 我们用另一个 AI，花了两天、烧掉 1.36 亿 token（词元），把它从头到尾拆开看了一遍。
...
整个过程消耗约 **1.36 亿 token**，历时 **两天**。每个概念用 9 问模板分析（是什么 / 从哪来 / 在哪里 / 依赖谁 / 怎么工作 / 解决什么 / 为什么不用别的 / 出错了会怎样 / 哪里可以调），织入 Martin Fowler（软件工程领域知名技术作家）风格的叙事中。
