...
4. **读 v1 对应章节**（`docs/archive/v0.11.0/zh/`），提取结构骨架——v1 覆盖了哪些维度、哪些深度。v2 必须覆盖 v1 维度的超集。没有 v1 对应的新章节，以 v1 中 `02-agent核心.md` 作为深度标杆。（注：v2 已全部完成，此步骤为历史流程记录）
5. 将清单记录到工作日志
