...
>
> We used another AI, spent two days and ~170 million tokens, and tore the whole thing apart.
...
| 10 | [Deployment](docs/en/10-deployment.md) | Six ways to run, from laptop to GPU cloud |
| 11 | [Batch & RL](docs/en/11-batch-and-rl.md) | The Agent as a training data factory |
| 12 | [Engineering](docs/en/12-engineering-practices.md) | How 587,000 lines get tested, logged, and secured |
